...
<c:if test="${not empty ingenicoPaymentInfoData}">
...
<c:choose>
    <c:when test="${not empty ingenicoPaymentInfoData}">
        <div class="account-paymentdetails account-list">
            <div class="account-cards card-select">
                <div class="row">
                    <c:forEach items="${ingenicoPaymentInfoData}" var="paymentInfo">
                        ...
                        <div class="display-none">
                            <div id="popup_confirm_payment_removal_${fn:escapeXml(paymentInfo.code)}"
                                ...
                                <c:url value="/my-account/ingenico/remove-payment-detail" var="removePaymentActionUrl"/>
                                <form:form id="removePaymentDetails${paymentInfo.code}" action="${removePaymentActionUrl}"
                                           method="post">
                                    <input type="hidden" name="paymentInfoId" value="${fn:escapeXml(paymentInfo.code)}"/>
                                    <br/>
