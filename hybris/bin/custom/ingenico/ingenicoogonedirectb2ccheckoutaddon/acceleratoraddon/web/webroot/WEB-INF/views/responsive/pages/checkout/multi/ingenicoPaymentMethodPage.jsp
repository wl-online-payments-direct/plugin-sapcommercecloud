                            ...
                            <div class="checkout-paymentmethod">
                                <div class="checkout-indent">
                                    ...
                                    <form:form id="ingenicoSelectPaymentForm" name="ingenicoSelectPaymentForm"
                                        ...
                                        <ingenico:paymentProductSelector paymentProducts="${paymentProducts}"/>
                                        ...
                                        <c:if test="${cartData.deliveryItemsQuantity > 0}">
                                            <div id="useIngenicoDeliveryAddressData"
                                            ...
                                            <formElement:formCheckbox
                                                    ...
                                                    idKey="useIngenicoDeliveryAddress"
                                        ...
                                        <ingenico:billAddressFormSelector supportedCountries="${countries}"
                                                                          regions="${regions}"
                                        ...
                                        <button type="button"
                                                class="btn btn-primary btn-block submit_ingenicoSelectPaymentForm checkout-next">
