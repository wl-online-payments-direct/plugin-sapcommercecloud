...
<spring:url value="/checkout/multi/ingenico/summary/placeOrder" var="placeOrderUrl" htmlEscape="false"/>
...
<div class="row">
			...
			<ycommerce:testId code="checkoutStepFour">
                ...
                <div class="place-order-form hidden-xs">
                    <form:form action="${placeOrderUrl}" id="placeOrderForm1" modelAttribute="placeOrderForm">
                        ...
                        <button id="placeOrder" type="submit" class="btn btn-primary btn-place-order btn-block checkout-next">
    ...
    <div class="col-sm-6">
		<ingenico:checkoutOrderSummary cartData="${cartData}"  showDeliveryAddress="true" showPaymentInfo="true" showTaxEstimate="true" showTax="true" />
	</div>
