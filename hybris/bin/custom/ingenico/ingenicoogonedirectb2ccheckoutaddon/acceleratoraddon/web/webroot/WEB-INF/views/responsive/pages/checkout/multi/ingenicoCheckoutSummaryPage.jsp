...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
    <jsp:body>
        <div class="row">
                ...
                <multi-checkout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
                    <ycommerce:testId code="checkoutStepFour">
                        ...
                        <div class="place-order-form hidden-xs">
                            <form:form action="${placeOrderUrl}" id="ingenicoPlaceOrderForm"
                                       modelAttribute="ingenicoPlaceOrderForm">
            ...
            <div class="col-sm-6">
                <ingenico:checkoutOrderSummary cartData="${cartData}" showDeliveryAddress="true" showPaymentInfo="true"
