...
<div id="ingenicoBillingCountrySelector" data-address-code="${fn:escapeXml(cartData.deliveryAddress.id)}" data-country-iso-code="${fn:escapeXml(cartData.deliveryAddress.country.isocode)}" data-display-title="false" class="clearfix">
...
<div id="ingenicoBillingAddressForm" class="ingenicoBillingAddressForm">
