...
public class WorldlineCheckoutFacadeImplPaymentOutputTest {
    ...
    public void getPaymentProductIdUsesMobileOutputWhenCardOutputDoesNotIdentifyProduct() {
        ...
        paymentOutput.setMobilePaymentMethodSpecificOutput(mobilePaymentMethodSpecificOutput(WorldlinegopaycoreConstants.PAYMENT_METHOD_GOOGLEPAY));

        Integer paymentProductId = facade.getPaymentProductId(paymentOutput);

        assertEquals(Integer.valueOf(WorldlinegopaycoreConstants.PAYMENT_METHOD_GOOGLEPAY), paymentProductId);
    }

    @Test
    public void getPaymentProductIdUsesCardOutputWhenOnlyCardOutputIdentifiesProduct() {
        PaymentOutput paymentOutput = new PaymentOutput();
        paymentOutput.setCardPaymentMethodSpecificOutput(cardPaymentMethodSpecificOutput(WorldlinegopaycoreConstants.PAYMENT_METHOD_VISA));

        Integer paymentProductId = facade.getPaymentProductId(paymentOutput);

        assertEquals(Integer.valueOf(WorldlinegopaycoreConstants.PAYMENT_METHOD_VISA), paymentProductId);
    }
    ...
    public void fillWorldlinePaymentInfoDataAllowsPayByLinkDuringAssistedService() throws WorldlineNonValidPaymentProductException {
        ...
        facade.fillWorldlinePaymentInfoData(paymentInfoData, null, WorldlinegopaycoreConstants.PAYMENT_METHOD_PAY_BY_LINK, null);

        assertEquals(Integer.valueOf(WorldlinegopaycoreConstants.PAYMENT_METHOD_PAY_BY_LINK), paymentInfoData.getId());
    ...
    public void fillWorldlinePaymentInfoDataRejectsPayByLinkOutsideAssistedService() throws WorldlineNonValidPaymentProductException {
        ...
        facade.fillWorldlinePaymentInfoData(new WorldlinePaymentInfoData(), null, WorldlinegopaycoreConstants.PAYMENT_METHOD_PAY_BY_LINK, null);
    }
    ...
    public void updatePaymentInfoStoresCardPaymentDetailsReturnedByWorldline() {
        CartModel order = new CartModel();
        WorldlinePaymentInfoModel paymentInfo = new WorldlinePaymentInfoModel();
        paymentInfo.setId(WorldlinegopaycoreConstants.PAYMENT_METHOD_VISA);
        ...
        assertEquals(Integer.valueOf(WorldlinegopaycoreConstants.PAYMENT_METHOD_VISA), paymentInfo.getWorldlinePaymentProductId());
    ...
    private PaymentResponse googlePayPaymentResponse() {
        ...
        MobilePaymentMethodSpecificOutput mobileOutput = mobilePaymentMethodSpecificOutput(WorldlinegopaycoreConstants.PAYMENT_METHOD_GOOGLEPAY);
    ...
    private PaymentResponse cardPaymentResponse() {
        ...
        CardPaymentMethodSpecificOutput cardOutput = cardPaymentMethodSpecificOutput(WorldlinegopaycoreConstants.PAYMENT_METHOD_VISA);
    ...
    private PaymentResponse googlePayPaymentResponseWithCardOutputWithoutToken() {
        ...
        paymentResponse.getPaymentOutput().setCardPaymentMethodSpecificOutput(
              cardPaymentMethodSpecificOutput(WorldlinegopaycoreConstants.PAYMENT_METHOD_VISA));
        return paymentResponse;
    }
    ...
    private static class TestableWorldlineCheckoutFacadeImpl extends WorldlineCheckoutFacadeImpl {
        ...
        public PaymentProduct getPaymentMethodById(int paymentId) {
            if (paymentId == WorldlinegopaycoreConstants.PAYMENT_METHOD_PAY_BY_LINK) {
