...
public class WorldlineHostedTokenizationMobilePopulatorTest {
    ...
    public void populateUsesGooglePayEncryptedPaymentDataFromSession() {
        sessionAttributes.put(WorldlinegopaycoreConstants.GOOGLE_PAY_ENCRYPTED_PAYMENT_DATA_SESSION_KEY, ENCRYPTED_PAYMENT_DATA);
    ...
    public void populateOmitsSaleAuthorizationFlagsForGooglePayWithoutThreeDSecure() {
        sessionAttributes.put(WorldlinegopaycoreConstants.GOOGLE_PAY_ENCRYPTED_PAYMENT_DATA_SESSION_KEY, ENCRYPTED_PAYMENT_DATA);
        sessionAttributes.put(WorldlinegopaycoreConstants.GOOGLE_PAY_MOBILE_DEVICE_SESSION_KEY, Boolean.TRUE);
    ...
    public void populateAddsThreeDSecureWhenServerDetectedDesktopDevice() {
        sessionAttributes.put(WorldlinegopaycoreConstants.GOOGLE_PAY_MOBILE_DEVICE_SESSION_KEY, Boolean.FALSE);
    ...
    private AbstractOrderModel order(Boolean recurringToken) {
        ...
        paymentInfo.setPaymentMethod(WorldlinegopaycoreConstants.PAYMENT_METHOD_TYPE.MOBILE.getValue());
        paymentInfo.setId(WorldlinegopaycoreConstants.PAYMENT_METHOD_GOOGLEPAY);
