package com.worldline.gopay.constants;


/**
 * Global class for all Worldlinegopaycore constants. You can add global constants for your extension into this class.
 */
public final class WorldlinegopaycoreConstants extends GeneratedWorldlinegopaycoreConstants {
    public static final String EXTENSIONNAME = "worldlinegopaycore";
    ...
    public static final int PAYMENT_METHOD_BANK_TRANSFER = 5408;
    ...
    private WorldlinegopaycoreConstants() {
