...
import com.worldline.gopay.enums.WorldlineExemptionType;
...
public class WorldlineConfigurationValidator implements ConstraintValidator<WorldlineConfigurationValid, WorldlineConfigurationModel>
{
    ...
    private static final String LOW_VALUE_ERROR_KEY = "com.worldline.gopay.error.3ds.lowvalue.message";
    private static final String TRANSACTION_RISK_ANALYSIS_LIMIT_KEY = "com.worldline.gopay.error.3ds.transactionriskanalysis.message";
    private static final String NO_CHALLENGE_REQUEST_ERROR_KEY = "com.worldline.gopay.error.3ds.nochallengerequest.message";
