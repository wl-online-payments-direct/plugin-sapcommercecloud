...
import com.worldline.gopay.enums.WeroCaptureTrigger;
import com.worldline.gopay.model.OneyPaymentModeModel;
...
import static com.worldline.gopay.populator.hostedcheckout.WorldlineHostedCheckoutBasicPopulator.HOSTED_CHECKOUT_RETURN_URL;
...
public class WorldlineHostedCheckoutRedirectPopulator implements Populator<AbstractOrderModel, CreateHostedCheckoutRequest> {
    ...
    private RedirectPaymentMethodSpecificInput getRedirectPaymentMethodSpecificInput(WorldlinePaymentInfoModel paymentInfo) {
        ...
        switch (paymentInfo.getId()) {
            case WorldlinegopaycoreConstants.PAYMENT_METHOD_PAYPAL:
                ...
                break;
            case WorldlinegopaycoreConstants.PAYMENT_METHOD_BANK_TRANSFER:
                ...
                break;
            case WorldlinegopaycoreConstants.PAYMENT_METHOD_CHEQUES_VACANCE_CONNECT:
                ...
                break;
            case WorldlinegopaycoreConstants.PAYMENT_METHOD_WERO:
                ...
                break;
            case WorldlinegopaycoreConstants.PAYMENT_METHOD_MEALVOUCHER:
