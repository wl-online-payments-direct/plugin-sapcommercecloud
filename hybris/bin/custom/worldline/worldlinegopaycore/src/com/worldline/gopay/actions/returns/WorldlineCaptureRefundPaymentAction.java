package com.worldline.gopay.actions.returns;
...
public class WorldlineCaptureRefundPaymentAction extends AbstractAction<ReturnProcessModel> {
   ...
   @Override public String execute(ReturnProcessModel returnProcessModel) throws RetryLaterException, Exception {
      ...
      if (paymentTransactionEntryModels.size() == 0) {
         ...
         if (paymentTransactionEntryModel.getTransactionStatusDetails().equals(WorldlinegopaycoreConstants.PAYMENT_STATUS_ENUM.REFUND_REQUESTED.getValue()) ||
               paymentTransactionEntryModel.getTransactionStatusDetails().equals(WorldlinegopaycoreConstants.PAYMENT_STATUS_ENUM.REFUNDED.getValue())) {
