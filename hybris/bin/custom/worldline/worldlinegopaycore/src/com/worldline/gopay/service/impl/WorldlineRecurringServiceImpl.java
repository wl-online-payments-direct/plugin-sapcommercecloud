...
import static com.worldline.gopay.constants.WorldlinegopaycoreConstants.*;
        ...
        if (paymentInfo instanceof WorldlinePaymentInfoModel) {
            ...
            switch (worldlinePaymentInfoModel.getId()) {
                case PAYMENT_METHOD_SEPA: {
                    ...
                    if (!(revokeMandate != null && WorldlinegopaycoreConstants.SEPA_MANDATE_STATUS.valueOf(revokeMandate.getMandate().getStatus()) == WorldlinegopaycoreConstants.SEPA_MANDATE_STATUS.REVOKED)) {
