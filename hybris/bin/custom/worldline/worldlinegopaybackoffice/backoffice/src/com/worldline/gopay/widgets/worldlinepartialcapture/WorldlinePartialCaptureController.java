package com.worldline.gopay.widgets.worldlinepartialcapture;
...
import static com.worldline.gopay.constants.WorldlinegopaycoreConstants.WORLDLINE_EVENT_PAYMENT;
...
public class WorldlinePartialCaptureController extends DefaultWidgetController {
    ...
    public void initCapturePaymentForm(OrderModel inputObject) {
        ...
        this.getWidgetInstanceManager().setTitle(this.getWidgetInstanceManager().getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.popup.title") + " " + this.getOrderModel().getCode());
        ...
        if (Messagebox.Button.YES.event.equals(obj.getName())) {
            try {
                ...
                if (nonCapturedAmount <= 0) {
                    Messagebox.show(this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.skipped.message"),
                            this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.confirm.title", new String[]{this.getOrderModel().getCode()}),
    ...
    protected void validateRequest() {
        ...
        if (!this.fullAmount.isChecked() && paymentAmount.doubleValue() <= 0.0) {
            throw new WrongValueException(this.amount, this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.wrong.amount.message"));
        }
    }

    protected void showMessageBox() {
        Messagebox.show(this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.confirm.message"),
                this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.confirm.title", new String[]{this.getOrderModel().getCode()}),
    ...
    protected void showWarningMessageBox(BigDecimal amountToCapture) {
        ...
        Messagebox.show(this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.warn.message", new String[]{amountToCapture.toString()}),
                this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.confirm.title", new String[]{this.getOrderModel().getCode()}),
    ...
    private void handleException(Exception exception) {
        Messagebox.show(this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.error.message"),
                this.getLabel("worldlinegopaycustomersupportbackoffice.partial.capture.confirm.title", new String[]{this.getOrderModel().getCode()}),
                1, "z-messagebox-icon z-messagebox-information", 0, null);
