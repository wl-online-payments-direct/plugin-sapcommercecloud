package com.worldline.gopay.wizard;
...
public class WorldlineFeatureRequestWizardFlowActionHandler implements FlowActionHandler {
    ...
    private static final String WORLDLINE_PLUGIN_VERSION_CONFIG = "worldline.gopay.api.shoppingCartExtension.version";
    private static final String WORLDLINE_FEATURE_REQUEST_EMAIL_CONFIG = "worldline.gopay.featurerequest.mailto";
    ...
    public void perform(CustomType customType, FlowActionHandlerAdapter flowActionHandlerAdapter, Map<String, String> map) {
        ...
        WorldlineConfigurationModel worldlineConfiguration = (WorldlineConfigurationModel) context.get(WorldlinegopaybackofficeConstants.WORLDLINE_CONFIG_WIZARD_CONTEXT);
    ...
    private String generateMailTo(FeatureRequestFormBean featureRequestFormBean, WorldlineConfigurationModel worldlineConfiguration) {
        ...
        mailToLink.append("?subject=Worldline GoPay SAP Commerce Plugin Feature Request");
        ...
        mailToLink.append("Worldline GoPay Plugin Version: ");
