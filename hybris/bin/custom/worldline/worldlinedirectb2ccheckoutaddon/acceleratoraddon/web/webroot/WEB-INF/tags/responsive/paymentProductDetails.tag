...
<c:choose>
    ...
    <c:otherwise>
        <div id="worldline_payment_product_${paymentProduct.id}" class="worldline_payment_product js-worldline_payment_product" title="<c:out value='${paymentProduct.displayHints.label}'/>">
