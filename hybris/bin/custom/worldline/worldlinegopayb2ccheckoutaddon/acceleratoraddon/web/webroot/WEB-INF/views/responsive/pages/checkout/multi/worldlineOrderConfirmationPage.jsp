...
<%@ taglib prefix="worldlineOrderTotals" tagdir="/WEB-INF/tags/addons/worldlinegopayb2ccheckoutaddon/responsive/order" %>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
    <jsp:body>
        ...
        <jsp:include page="/WEB-INF/views/addons/worldlinegopayb2ccheckoutaddon/responsive/cms/mandate/worldlineMandateDetails.jsp"/>
