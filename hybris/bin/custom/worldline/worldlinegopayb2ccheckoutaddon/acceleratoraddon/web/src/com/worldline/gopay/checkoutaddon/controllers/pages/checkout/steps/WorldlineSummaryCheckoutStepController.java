...
import com.worldline.gopay.checkoutaddon.controllers.WorldlineWebConstants.URL.Checkout.Summary;
import com.worldline.gopay.checkoutaddon.controllers.utils.WorldlinePlaceOrderUtils;
import com.worldline.gopay.checkoutaddon.forms.WorldlinePlaceOrderForm;
...
public class WorldlineSummaryCheckoutStepController extends AbstractCheckoutStepController {
    ...
    private WorldlineGoPayCheckoutFacade worldlineGoPayCheckoutFacade;
    ...
    public String placeOrder(@ModelAttribute("worldlinePlaceOrderForm") final WorldlinePlaceOrderForm worldlinePlaceOrderForm,
        ...
        try {
            ...
            abstractOrderData = worldlineGoPayCheckoutFacade.placeOrder(placeOrderData);
