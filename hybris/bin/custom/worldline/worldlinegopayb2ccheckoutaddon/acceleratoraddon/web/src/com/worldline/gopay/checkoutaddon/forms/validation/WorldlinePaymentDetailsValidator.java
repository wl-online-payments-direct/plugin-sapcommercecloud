...
package com.worldline.gopay.checkoutaddon.forms.validation;
...
public class WorldlinePaymentDetailsValidator implements Validator {
    ...
    public void validate(final Object object, final Errors errors) {
        ...
        if (form.getPaymentProductId() != null) {
            if (WorldlinegopaycoreConstants.PAYMENT_METHOD_HTP == form.getPaymentProductId()) {
            ...
            } else if (WorldlinegopaycoreConstants.PAYMENT_METHOD_GOOGLEPAY == form.getPaymentProductId()) {
