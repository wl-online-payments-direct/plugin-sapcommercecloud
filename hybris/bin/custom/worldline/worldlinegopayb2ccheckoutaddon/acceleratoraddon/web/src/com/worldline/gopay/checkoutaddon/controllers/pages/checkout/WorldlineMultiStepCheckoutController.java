package com.worldline.gopay.checkoutaddon.controllers.pages.checkout;
...
public class WorldlineMultiStepCheckoutController extends AbstractCheckoutStepController {
   ...
   private static final Logger
         LOGGER = Logger.getLogger(com.worldline.gopay.checkoutaddon.controllers.pages.checkout.WorldlineMultiStepCheckoutController.class);
   ...
   public String getTermsAndConditions(final Model model) throws CMSItemNotFoundException
   {
      ...
      return WorldlineWebConstants.Views.Fragments.Checkout.TermsAndConditionsPopup;
   }
...
//                  "checkout.express.error.paymentInfo");
   ...
   public String getProductVariantMatrix(@RequestParam("productCode") final String productCode, final Model model)
   {
      ...
      return WorldlineWebConstants.Views.Fragments.Checkout.ReadOnlyExpandedOrderForm;
   }
