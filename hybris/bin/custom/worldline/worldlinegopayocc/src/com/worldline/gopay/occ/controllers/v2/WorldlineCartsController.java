...
import com.worldline.gopay.occ.controllers.v2.validator.WorldlinePaymentDetailsWsDTOValidator;
...
import com.worldline.gopay.payment.dto.PaymentProductListWsDTO;
import com.worldline.gopay.payment.dto.WorldlineCheckoutTypeWsDTO;
import com.worldline.gopay.payment.dto.WorldlinePaymentDetailsWsDTO;
...
import static com.worldline.gopay.occ.controllers.v2.WorldlineB2BOrdersController.OBJECT_NAME_SCHEDULE_REPLENISHMENT_FORM;
...
public class WorldlineCartsController extends WorldlineBaseController {
    ...
    public Boolean displaySurcharge (
        ...
        List<PaymentProduct> availablePaymentMethods = worldlinePaymentProductFilterStrategyFactory.filter(worldlineCheckoutFacade.getAvailablePaymentMethods(), WorldlinePaymentProductFilterEnum.ACTIVE_PAYMENTS, WorldlinePaymentProductFilterEnum.CHECKOUT_TYPE, WorldlinePaymentProductFilterEnum.GROUP_CARDS, WorldlinePaymentProductFilterEnum.NAMES, WorldlinePaymentProductFilterEnum.SORT).get();
        availablePaymentMethods = worldlinePaymentProductFilterStrategyFactory.filter(availablePaymentMethods, cartFacade.getSessionCart()).get();
