...
import com.worldline.gopay.b2bcheckoutaddon.forms.WorldlineReplenishmentForm;
...
public class WorldlineB2BCartPageController extends AbstractCartPageController {
   ...
   protected void prepareDataForPage(final Model model) throws CMSItemNotFoundException
   {
      ...
      if (cart.isReplenishmentOrder()) {
         ...
         worldlineReplenishmentForm.setnDaysOfWeek(daysOfWeek);
         model.addAttribute("replenishmentForm", worldlineReplenishmentForm);
      }
      ...
      model.addAttribute("daysOfWeek", worldlineGoPayCheckoutFacade.getDaysOfWeekForReplenishmentCheckoutSummary());
