package com.worldline.gopay.b2bcheckoutaddon.controllers.pages;
...
public class WorldlineB2BMultiStepCheckoutController extends AbstractCheckoutStepController {

   protected static final String REDIRECT_URL_ADD_DELIVERY_ADDRESS = REDIRECT_PREFIX + "/checkout/multi/worldline/delivery-address/add";
   protected static final String REDIRECT_URL_CHOOSE_DELIVERY_METHOD = REDIRECT_PREFIX + "/checkout/multi/delivery-method/choose";
   protected static final String REDIRECT_URL_ADD_PAYMENT_METHOD = REDIRECT_PREFIX + "/checkout/multi/worldline/payment/select-payment-method";
   protected static final String REDIRECT_URL_SUMMARY = REDIRECT_PREFIX + "/checkout/multi/worldline/summary/view";
   protected static final String REDIRECT_URL_CART = REDIRECT_PREFIX + "/cart";

   private static final Logger
         LOGGER = Logger.getLogger(com.worldline.gopay.b2bcheckoutaddon.controllers.pages.WorldlineB2BMultiStepCheckoutController.class);
   ...
   public String getTermsAndConditions(final Model model) throws CMSItemNotFoundException
   {
      ...
      return WorldlineCheckoutConstants.Views.Fragments.Checkout.TermsAndConditionsPopup;
   }
...
//                  "checkout.express.error.paymentInfo");
   ...
   public String getProductVariantMatrix(@RequestParam("productCode") final String productCode, final Model model)
   {
      ...
      return WorldlineCheckoutConstants.Views.Fragments.Checkout.ReadOnlyExpandedOrderForm;
   }
